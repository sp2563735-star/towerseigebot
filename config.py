...
MOVES = {
    "pandey_slash": {
        "name": "Nirvana Sword Slash", "type": "attack", "damage": 50, "max_uses": 1,
    ...
    "chandal_eyes": {
        "name": "Chandal Eyes", "type": "redirect", "max_uses": 1,
    ...
    "bengali_shield": {
        "name": "Holy Shield", "type": "shield", "max_uses": 1,
    ...
    "yadav_milk": {
        "name": "Magic Milk", "type": "heal", "heal": 25, "max_uses": 2,
        "narrate": False, "needs_target": False, "class": "Healer",
    },
    "jharkhand_seal": {
        "name": "Judgement Seal", "type": "seal", "max_uses": 1,
    ...
    "rajpoot_mirror": {
        "name": "Divine Slash Reflection", "type": "counter_pandey", "max_uses": 1,
        "narrate": True, "needs_target": False, "class": "Mage",
    ...
    "chamar_teleporter": {
        "name": "Dino Dimension", "type": "kidnap", "max_uses": 1,
        "narrate": True, "needs_target": True, "class": "Knight",
        "flavor": "{target} has vanished from their tower. {attacker} the Knight is behind it.",
    },
    "almighty_mulla": {
        "name": "Almighty Mulla", "type": "escape", "max_uses": 1,
    ...
    "super_soldier_serum": {
        "name": "Super Soldier Serum", "type": "soldier_boost", "max_uses": 1,
...
ALLIANCE_MOVES = {
    "seelampur_strike": {
        "name": "Seelampur Strike", "type": "alliance_attack", "damage": 100, "max_uses": 1,
    ...
    "zoya_spear": {
        "name": "Ice Spear", "type": "alliance_freeze", "max_uses": 1,
    ...
    "bhoomi_domain": {
        "name": "Boundless Tower Domain", "type": "alliance_ward", "max_uses": None,
        "narrate": True, "needs_target": False,
